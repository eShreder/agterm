...
public struct Agtermctl: ParsableCommand {
    public static let configuration = CommandConfiguration(
        ...
        subcommands: [Tree.self, Workspace.self, Session.self, Window.self, Quick.self, Sidebar.self, Notify.self,
                      Font.self, Keymap.self, Config.self, Theme.self, Restore.self, Tmux.self, TmuxPipe.self]
    )
